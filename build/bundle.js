...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = (function (_React$Component) {
		...
		_createClass(Home, [{
			key: "renderPortfolioItems",
			value: function renderPortfolioItems() {
				return this.props.portfolioItems.map(function (portfolioItem) {
					return _react2["default"].createElement(
						"li",
			...
			value: function render() {
				...
				var portfolioItems = this.renderPortfolioItems();
				return _react2["default"].createElement(
					"div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataPortfolioJs = __webpack_require__(192);
