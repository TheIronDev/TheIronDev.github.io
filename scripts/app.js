...
/**
 * Apply padding to the top of the page to properly shape the header
 */
...
(function loadPortfolioSections() {
  /**
   * Build out a portfolio section
   * @param {Object} portfolio - portfolio
   * @return {Element} Element to render in the portfolio overview
   */
  ...
  /**
   * Build out a portfolio section anchor-icon
   * @param {Object} portfolio - portfolio
   * @return {Element} Element to render in the portfolio overview
   */
